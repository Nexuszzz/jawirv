...
export function setupIpcHandlers(ipcMain, serverManager) {
    ...
    ipcMain.handle('voice:set-mode', async (_event, mode) => {
        // TODO: Implement in Phase 3
